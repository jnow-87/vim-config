...
syn match makeIdent	"\$[^({]"
syn match makeIdent	"^ *[a-zA-Z0-9_\.-]\{0,}\s*[:+?!*]="me=e-2
syn match makeIdent	"^ *[a-zA-Z0-9_\.-]\{0,}\s*="me=e-1
syn match makeIdent	"%"
...
syn match makeStatement contained "(\(subst\|abspath\|addprefix\|addsuffix\|and\|basename\|call\|dir\|error\|eval\|filter-out\|filter\|findstring\|firstword\|flavor\|foreach\|if\|info\|join\|lastword\|notdir\|or\|origin\|patsubst\|realpath\|shell\|sort\|strip\|suffix\|value\|warning\|wildcard\|word\|wordlist\|words\)\s"ms=s+1
