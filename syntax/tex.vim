...
"  HiLink texZone		PreCondit
  ...
  HiLink texCmdArgs		mblue  " [...]
  HiLink texCmdName		string  "\begin{itemize}
  HiLink texComment		mgreen
  HiLink texDef			normal
  HiLink texDefParm		normal
  HiLink texDelimiter		mblue		" trennzeichen bspw. im align "&"
  HiLink texInput		normal
  HiLink texInputFile		mblue		"dateinamen
  HiLink texLength		normal		"Laengenangaben
  HiLink texMath		mblue		"mathe inhalte und align ...
  HiLink texMathDelim		normal
  HiLink texMathOper		normal
  HiLink texNewCmd		normal
  HiLink texNewEnv		normal
  HiLink texOption		normal
  HiLink texRefZone		normal
  HiLink texSection		mblue 		"itemize, document ...
  HiLink texSpaceCodeChar	normal
  HiLink texSpecialChar		type	"methasymmbole \% \\ ...
  HiLink texStatement	string	"\item \input \usepackage \begin{align}
  HiLink texString		normal
  HiLink texTodo		normal
  HiLink texType		type	"\normalsize
  HiLink texZone		normal
