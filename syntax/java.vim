...
if version >= 508 || !exists("did_java_syn_inits")
  ...
  JavaHiLink javaFuncDef		Comment
  JavaHiLink javaVarArg                 Comment
  JavaHiLink javaBraces			Comment
  JavaHiLink javaBranch			Comment
  JavaHiLink javaUserLabelRef		Comment
  JavaHiLink javaLabel			Comment
  JavaHiLink javaUserLabel		Comment
  JavaHiLink javaConditional		Comment
  JavaHiLink javaRepeat			Comment
  JavaHiLink javaExceptions		Comment
  JavaHiLink javaAssert			Comment
  JavaHiLink javaStorageClass		Comment
  JavaHiLink javaMethodDecl		Comment
  JavaHiLink javaClassDecl		Comment
  JavaHiLink javaScopeDecl		Comment
  JavaHiLink javaBoolean		Comment
  JavaHiLink javaSpecial		Comment
  JavaHiLink javaSpecialError		Comment
  JavaHiLink javaSpecialCharError	Comment
  JavaHiLink javaString			normal
  JavaHiLink javaCharacter		normal
  JavaHiLink javaSpecialChar	normal
  JavaHiLink javaNumber		normal
  JavaHiLink javaError			Comment
  JavaHiLink javaStringError		Comment
  JavaHiLink javaStatement		Comment
  JavaHiLink javaOperator		Comment
  JavaHiLink javaComment		mgreen
  JavaHiLink javaDocComment		mgreen
  JavaHiLink javaLineComment		mgreen
  JavaHiLink javaConstant		normal
  JavaHiLink javaTypedef		Comment
  JavaHiLink javaTodo			Todo
  JavaHiLink javaAnnotation             Comment

  JavaHiLink javaCommentTitle 		mgreen
  JavaHiLink javaDocTags		mgreen
  JavaHiLink javaDocParam		mgreen
  JavaHiLink javaDocSeeTagParam		Comment
  JavaHiLink javaCommentStar		mgreen

  JavaHiLink javaType			Comment
  JavaHiLink javaExternal		Comment

  JavaHiLink htmlComment		mgreen
  JavaHiLink htmlCommentPart		mgreen
  JavaHiLink javaSpaceError		Comment
endif
